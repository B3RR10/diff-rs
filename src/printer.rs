...
///
pub fn print(files: &[File], _columnview: Option<&str>) -> String {
    ...
    files.iter().for_each(|file| {
        ...
        printable_output.push_str(&get_horizontal_line(term_width, ln_width, LINE_ANCHOR_DOWN));
    });
...
mod tests {
    ...
    fn print_file_test() {
        ...
        assert_eq!(expected_output, print(&[file], None));
    }
}
